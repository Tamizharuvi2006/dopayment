(function () {
  const ICONS = {
    ...
    'truck': '<path d="M5 18H3c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2v10h2c1.1 0 2 .9 2 2v2"/><circle cx="8" cy="18" r="2"/><circle cx="18" cy="18" r="2"/><path d="M15 6h4.5c.83 0 1.5.67 1.5 1.5v4.5"/>',
    'factory': '<path d="M2 20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8l-7 5V8l-7 5V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"/><path d="M17 18h1"/><path d="M13 18h1"/><path d="M9 18h1"/>',
  ...
  function svg(name) {
    ...
    return `<span class="dp-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="dp-icon-svg" width="1em" height="1em" aria-hidden="true">${paths}</svg></span>`;
  }

  function rawSvg(name) {
    const paths = ICONS[name] || ICONS.activity;
    return `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="dp-icon-svg" width="1em" height="1em" aria-hidden="true">${paths}</svg>`;
  }

  window.DPIcons = { svg, rawSvg, ICONS };
}());
